...
function showtitle(){
	...
	var html = "<span class=\"fr s1\" style=\"margin:0 16px\">当前日期-" + "2012-10-14" + " | 用户: admin　级别: manager　|　<a class=\"s0\"  href=\"javascript:\" onclick=\"return skin(\'?adskin=2\');\">默认风格</a>  <a class=\"s0\" href=\"vbscript:parent.main.location.reload\" >刷新</a> <a class=\"s0\" href=\"vbscript:history.back\" >上一步</a> <a class=\"s0\" href=\"vbscript:history.forward\">下一步</a> <a class=\"s0\" href=\"vbscript:exitsystem()\">退出</a></span>";
	if(action && type){
