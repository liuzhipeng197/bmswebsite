...
var guides={
	'a_xxygj' : {
		'a_dxyyj' : {
			'a_dxyyj_1' : ['框架里打开','read.htm',''],          //框架里打开
			'a_dxyyj_2' : ['框架多级','read.htm','m'],       //框架多级别导航			
			'a_dxyyj_3' : ['新开页打开','read.htm','_blank'],    //新开页打开
			'a_dxyyj_4' : ['本页打开','read.htm','_parent']    //本页打开
	...
	'glmk' : {
		'glmk_1' : {
			...
			'glmk_1_2' : ['模块','module/dagl/frame1.htm'],
			'glmk_1_n' : ['模块','module/dagl/frame2.htm']}},
...
function showguide3(id){
	...
	for(i in guide){
		...
		for(j in subs){
			var sub = subs[j];
			html += '<a href="javascript:" onclick="return initguide3(\''+id+'\',\''+j+'\')">'+sub[0]+'</a>';
		}
		html += '</dd>';
	}
	obj.innerHTML = html + '</dl>';
