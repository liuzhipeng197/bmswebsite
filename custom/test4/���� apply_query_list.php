<?php
	...
	$str_class=intval($str_dataarry[1]);			//0代表初始，1代表按序号，2代表按样品名称，3代表按样品类型查询，4代表按时间查询
	if($str_class==4){
	...
	echo "<table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
    		 <tr>
				...
				if($str_class!=4){
					...
					echo "<input type='radio' id='search_type' name='search_type'  value='0'><b>按条件</b>";
				}
				...
				if($str_class==0||$str_class==1||$str_class==4){
					echo "<option value=\"0\" selected=\"selected\">按委托书号查询</option>
						<option value=\"1\">按样品名称查询</option>
						<option value=\"2\">按样品类型查询</option>
						</select>&nbsp;&nbsp; &nbsp;&nbsp;
					...
					<select id=\"test_obj\" name=\"test_obj\" style=\"display: none; width:124px;font-size:12px\"onchange=\"changetestobj()\">
						<option value=\"222\">环境</option>
						<option value=\"1\">存储</option>
					</select>&nbsp;&nbsp; &nbsp;&nbsp;";
				}else if($str_class==2){
					echo "<option value=\"0\">按委托书号查询</option>
						<option value=\"1\" selected=\"selected\">按样品名称查询</option>
						<option value=\"2\">按样品类型查询</option>
						</select>&nbsp;&nbsp; &nbsp;&nbsp;
					<input type=\"text\" id=\"condition1\" name=\"condition1\" size=\"15\" style=\"display:inline\";>
					<select id=\"test_obj\" name=\"test_obj\" style=\"display: none; width:124px;font-size:12px\"onchange=\"changetestobj()\">
					...
					echo "<option value=\"0\">按委托书号查询</option>
						<option value=\"1\">按样品名称查询</option>
						<option value=\"2\" selected=\"selected\">按样品类型查询</option>
						</select>&nbsp;&nbsp; &nbsp;&nbsp;
