	...
	<td height="30" background="../images/tab_05.gif">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class='td_head' style="text-align:center">&nbsp;&nbsp;<b><?php echo "委托书信息";?></b></td>
	...
	<td height="30" background="../images/tab_05.gif" style='padding-top:50px'>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class='td_head' style='text-align:center'>&nbsp;&nbsp;<b><?php echo "样品信息";?></b></td>
...
<tr><!-- 标题栏-1 -->
	<td height="30" background="../images/tab_05.gif" style='padding-top:50px'>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class='td_head' style='text-align:center'>&nbsp;&nbsp;<b><?php echo "资料列表";?></b></td>
	...
	<td height="30" background="../images/tab_05.gif" style='padding-top:50px'>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class='td_head' style='text-align:center'>&nbsp;&nbsp;<b><?php echo "业务受理状态";?></b></td>
...
<tr style='margin:0px 0px 30px 0px'><!-- 主要内容3 -->
        <td>
                <table  width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
                <td width="8">&nbsp;</td>
            <td style='padding-top:20px'>
               ...
               <tr>
				...
				if($str_deal=='已受理'){
				echo "
                <input type=\"button\" class='edit_buttom' name=\"button\" id=\"button\"  onclick=\"jump('req_gen.php?req_id=$req_id&sample_id=$sample_id&req_table=$req_table&uid=$uid')\" value=\"生成委托书\" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"button\"  class='edit_buttom' id=\"btn_sample_gen\"  onclick=\"jump('sample_info_gen.php?sample_id2=$sample_id&uid2=$uid')\" value=\"生成样品信息表\" />
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"button\" class='edit_buttom' id=\"btn_cancle\" onclick=cancle() value=\"返  回\">";
}else {
     echo "
                <input type=\"button\"  class='edit_buttom_disabled' name=\"button\" id=\"button\"  disabled value=\"生成委托书\" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"button\"  class='edit_buttom_disabled' id=\"btn_sample_gen\"   disabled  value=\"生成样品信息表\" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"button\" class='edit_buttom' id=\"btn_cancle\" onclick=cancle() value=\"返  回\">";
