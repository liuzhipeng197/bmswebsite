...
<?php
	...
	$sql = "select * from nstc_test_req where id='$coreinfo_id'";
...
<script type="text/javascript" language="JavaScript"> 
 function coreinfo_modify(){
			...
			if(author==''){
				...
				$.post("./edit_task.php",{action:"test_req_modify",coreinfoId:coreinfo_id,
 ...
 function coreinfo_audit(){
 	var coreinfo_id="<?echo $coreinfo_id?>";
 	$.post("./edit_task.php",{action:"test_req_audit",coreinfoId:coreinfo_id},function(data){
 				if(data){
 					//alert(data);
 					alert("操作成功！");
 					//clear();
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  		<tr>
  			...
  			<td width="100%" align="left" ><div id="right_topcenter">当前位置：测评申请 > 修改测评申请</div></td>
...
<tr><!-- 主要内容1 -->
	<td>
		...
		<textarea id="content1" name="content1" cols="100" rows="8" style="width:700px;height:338px;visibility:hidden;"><?echo htmlspecialchars($content); ?></textarea>
