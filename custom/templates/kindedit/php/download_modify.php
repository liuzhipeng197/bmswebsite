...
<?php
	...
	$sql = "select * from nstc_download where id='$coreinfo_id'";
...
function coreinfo_modify(){
			...
			if(title==''){
				...
				$.post("./edit_task.php",{action:"download_modify",coreinfoId:coreinfo_id,
 ...
 function coreinfo_audit(){
 	var coreinfo_id="<?echo $coreinfo_id?>";
 	$.post("./edit_task.php",{action:"download_audit",coreinfoId:coreinfo_id},function(data){
 				if(data){
 					//alert(data);
 					alert("操作成功！");
 					//clear();
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  		<tr>
  			...
  			<td width="100%" align="left" ><div id="right_topcenter">当前位置：下载中心 > 修改下载</div></td>
        ...
        <tr>
            ...
            <td>
                ...
                <tr>
                	 ...
                	 <td  height="30" style="font-size:13;">&nbsp;&nbsp;下载标题：<input type="text" id="title" name="title" size="45" value="<?php echo $title?>"></td>
...
<tr> 
	<td height="40" valign="middle" align="center">
		...
		<input type="button" name="button" id="button" disabled="disabled" onclick="coreinfo_modify()"value="完成修改" />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
