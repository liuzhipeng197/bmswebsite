...
<?php
	...
	$sql = "select *from nstc_anony_msg where id=$coreinfo_id";
...
<script type="text/javascript" language="JavaScript"> 
 function coreinfo_modify(){
			...
			$.post("./edit_task.php",{action:"msg_answer",coreinfoId:coreinfo_id,
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  		<tr>
  			...
  			<td width="100%" align="left" ><div id="right_topcenter">当前位置：Q&A > 回复留言</div></td>
	...
	<td>
        ...
        <tr>
            ...
            <td>
                ...
                <tr>
                	 <td  height="30" style="font-size:13;">&nbsp;&nbsp;留言标题：<input type="text" id="title" name="title" size="45" disabled value="<?php echo $title?>"></td>
                	<td   height="30" style="font-size:13;">&nbsp;&nbsp;提问者：&nbsp;&nbsp;&nbsp;<input type="text" id="author" name="author" size="45" disabled  value="<?php echo $reg_name?>"></td>
                </tr>
            	 <tr>
                	 <td  height="30" style="font-size:13;">&nbsp;&nbsp;Email：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="reg_email" name="reg_email" size="45" disabled value="<?php echo $reg_email?>"></td>
                	<td   height="30" style="font-size:13;">&nbsp;&nbsp;公司名称：<input type="text" id="com_name" name="com_name" size="45" disabled  value="<?php echo $com_name?>"></td>
                </tr>
                 <tr>
                	 <td  height="30" style="font-size:13;">&nbsp;&nbsp;留言时间：<input type="text" id="time" name="time" size="45" disabled value="<?php echo $ques_date." ".$ques_time?>"></td>
             ...
             &nbsp;&nbsp;留言内容：<textarea id="ques_content" disabled name="ques_content" cols="100" rows="8" style="width:260px;height:100px;"><?echo $ques_content; ?></textarea>
		     </br>
              &nbsp;&nbsp;回复内容：<textarea id="content1" name="content1" cols="100" rows="8" style="width:780px;height:150px;visibility:hidden;"><?echo htmlspecialchars($ques_answer);?></textarea>
