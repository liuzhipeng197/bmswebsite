...
<?php
	...
	$sql = "select * from nstc_friend_link where id='$coreinfo_id'";
...
<script type="text/javascript" language="JavaScript"> 
 function coreinfo_modify(){
			...
			if(link_title==''){
				...
				$.post("./edit_task.php",{action:"frilink_modify",coreinfoId:coreinfo_id,
				link_title:link_title,link_addr:link_addr},function(data){
 				if(data){
 					//alert(data);
 					alert("修改成功！");
 					window.location.href='frilink_show.php';
 					//clear();
 				}else{
 					alert("修改失败！请修改标题");
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  		<tr>
  			...
  			<td width="100%" align="left" ><div id="right_topcenter">当前位置：友情链接 > 修改友情链接</div></td>
...
<tr><!-- 标题栏-1 -->
	<td height="30" background="../../../images/tab_05.gif">
        ...
        <tr>
            ...
            <td><img src="../../../images/tb.gif" width="16" height="16" />&nbsp;&nbsp;<b>修改友情链接</b></td>
	...
	<td>
        ...
        <tr>
            ...
            <td>
            	...
            	<tr>
                	  <td   height="30" style="font-size:13;">&nbsp;&nbsp;链接名称：<input type="text" id="link_title" name="link_title" size="45"  value="<?echo $title?>"></td>
                	 <td   height="30" style="font-size:13;">&nbsp;&nbsp;链接地址：<input type="text" id="link_addr" name="link_addr" size="45"  value="<?echo $addr?>"></td>
                </tr>
...
<tr> 
	<td height="40" valign="middle" align="center">
		...
		<input type="button" name="button" id="button"  onclick="coreinfo_modify()"value="提 交" />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
