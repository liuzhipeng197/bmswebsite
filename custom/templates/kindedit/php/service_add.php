...
<script type="text/javascript" language="JavaScript"> 
 function coreinfo_add(){
			...
			if(author==''){
				...
				$.post("./edit_task.php",{action:"service_add",mytype:type,mytitle:title,
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  		<tr>
  			...
  			<td width="100%" align="left" ><div id="right_topcenter">当前位置：测评服务 > 发布测评服务</div></td>
...
<tr><!-- 标题栏-1 -->
	<td height="30" background="../../../images/tab_05.gif">
        ...
        <tr>
            ...
            <td><img src="../../../images/tb.gif" width="16" height="16" />&nbsp;&nbsp;<b>发布测评服务</b></td>
...
<tr><!-- 主要内容1 -->
	<td>
        ...
        <tr>
            ...
            <td>
            	...
            	<tr>
                	 ...
                	 <option value="0" selected="selected">测评规范</option>
		...
		<textarea id="content1" name="content1" cols="100" rows="8" style="width:700px;height:310px;visibility:hidden;"></textarea>
