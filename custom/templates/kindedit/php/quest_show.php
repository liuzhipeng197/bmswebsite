...
<script language="javascript">
	window.onload=init;
	function init(){
		$.post("./edit_task.php",{action:"quest_init"},function(data){
		  if(data){
		  	//alert(data);
	...
	function del_coreinfo(coreinfoid){//根据id号来删除配置环境的信息
		...
		//{
			$.post("./edit_task.php",{action:"quest_del",coreinfoId:coreinfoid},function(data){
		  		if(data){
		  			alert('删除成功');
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  		<tr>
  			...
  			<td width="100%" align="left" ><div id="right_topcenter">当前位置：Q&A > 查看提问</div></td>
...
<tr><!-- 标题栏-1 -->
	<td height="30" background="../../../images/tab_05.gif">
        ...
        <tr>
            ...
            <td><img src="../../../images/tb.gif" width="16" height="16" />&nbsp;&nbsp;<b>问题列表</b></td>
