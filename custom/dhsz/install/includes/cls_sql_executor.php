...
class sql_executor
{
     ...
     *
     * @access  private
     * @var     string      $change_mysql_charset
     */
	var $change_mysql_charset = '';
     ...
     * @return  void
     */
    function __construct($db, $charset = 'gbk', $sprefix = 'nitc_', $tprefix = 'nitc_', $temp_url = '', $temp_charset = '', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
        $this->sql_executor($db, $charset, $sprefix, $tprefix, $temp_url, $temp_charset, $log_path, $auto_match, $ignored_errors);
    }
     ...
     * @return  void
     */
    function sql_executor($db, $charset = 'gbk', $sprefix = 'nitc_', $tprefix = 'nitc_', $temp_url = '', $temp_charset = '', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
        $this->db = $db;
        $this->db_charset = $charset;
        $this->source_prefix = $sprefix;
        $this->target_prefix = $tprefix;
		$this->change_url = $temp_url;
		$this->change_mysql_charset = $temp_charset;
    ...
    {
		$query_items = $this->parse_sql_file($sql_files);
    ...
    function replace_prefix($sql)
    {
		...
		$sql = str_replace("-HTTP_URL_CHANGE",$this->change_url,$sql);
		$sql = str_replace("-MYSQL_CHARSET_CHANGE",$this->change_mysql_charset,$sql);
