<?php
define('IN_LOCK', true);
define('ALL_ROOT_PATH', str_replace('includes/ckeditor/plugins/ckfinder/config.php', '', str_replace('\\', '/', __FILE__)));
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = ALL_ROOT_PATH."upload/file/";
/*
 * ### Advanced Settings
 */
