		...
		<div class="page">
            ...
            <div class="inquiry">
                ...
                <form name="theForm" action="<?php echo $conf['weburl'];?>/inquiry.php?action=send" method="post"  onsubmit="return doInquirySubmit()">
                    ...
                    <span class="msgbase">
                        <textarea name="content" cols="50" rows="8" id="content" onblur="contentCheck('content')"><?php echo $content;?></textarea>
                    </span>
                    ...
                    <li><p><font color="#FF0000">*</font><?php echo $lang['inquiry_company'];?>:</p><span><span id="c">
                            <span class="msgbase">
                                <input name="companyName" type="text" id="companyName" value="<?php echo $companyName;?>" onblur="companyNameCheck('companyName')" size="28" />
                            </span>
                            <span class="msg">
                   ...
                   <span><input  type="radio"  name="sex"  value="<?php echo $lang['inquiry_mr'];?>" checked="checked"  /><label><?php echo $lang['inquiry_mr'];?></label>
                    ...
                    <li><p><font color="#FF0000">*</font><?php echo $lang['inquiry_email'];?>:</p><span><span id="e">
                            <span class="msgbase">
                                <input name="email" type="text" id="email" value="<?php echo $email;?>" onblur="emailCheck('email')" size="28" />
                            </span>
                            <span class="msg" style="clear:both; width:400px;">
                    ...
                    <li><p><font color="#FF0000">*</font><?php echo $lang['inquiry_tel'];?>:</p><span><span id="f">
                            <span class="msgbase">
                                <input name="tel" type="text" id="tel" value="<?php echo $tel;?>" onblur="telCheck('tel')" size="28" />
                            </span>
                            <span class="msg">
                                <span class="" id="telMsg" style="display:none;"></span>
                            </span>
                        </span></span></li>
                    <li><p><?php echo $lang['inquiry_fax'];?>:</p><span><span><input name="fax" type="text" value="<?php echo $fax;?>" id="fax" size="28" /></span></span></li>
                    <?php if ($directory=='en'){ ?>
