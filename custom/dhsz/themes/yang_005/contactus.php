...
<?php echo $navSubDiv; ?> <?php echo $navSubJsSetup; ?>
<div class="wrapper">
...
<ul>
  ...
  <li>
    <p><b><?php echo $company_desc['company_name'];?></b></p>
    <?php if ($company_desc['website']) : ?>
    <p><?php echo $lang['website'];?>: <?php echo $company_desc['website'];?></p>
    <?php endif ; ?>
    <?php endif ; ?>
    <?php if ($company_desc['address']) : ?>
    <p><?php echo $lang['address'];?>: <?php echo $company_desc['address'];?></p>
    <?php if ($company['zip']) : ?>
    <p><?php echo $lang['zip'];?>: <?php echo $company['zip'];?></p>
    <?php endif ; ?>
    <?php endif ; ?>
  </li>
</ul>
...
<li class="departmentname">
  <?php if ($value['contact_detail']['company_name']){ echo $value['contact_detail']['company_name']; }?>
  <?php if ($value['contact_detail']['company_name'] && $value['contact_detail']['department']){ echo "&nbsp;-&nbsp;"; }?>
  <?php if ($value['contact_detail']['department']){ echo $value['contact_detail']['department']; }?>
</li>
</ul>
<?php else : ?>
<ul>
  <?php endif ; ?>
  <li>
    <p> <?php echo $lang['contact_person'];?>: <?php echo $value['contact_detail']['contact_person'];?></p>
    <p>
      <?php foreach ($value['detail_tel_arr'] as $keyx => $valuex)  { ?>
      <?php if ($keyx==0){ echo $lang['tel'].":"; }?>
      <?php echo $valuex;?>
      <?php } ?>
    </p>
    <?php if ($value['contact_detail']['fax']) : ?>
    <p><?php echo $lang['fax'];?>: <?php echo $value['contact_detail']['fax'];?></p>
    <?php endif ; ?>
    ...
    <?php if ($value['contact_detail']['zip']) : ?>
    <p><?php echo $lang['zip'];?>: <?php echo $value['contact_detail']['zip'];?></p>
    <?php endif ; ?>
    <?php endif ; ?>
  </li>
  <li>
    <p>
      <?php if ($value['qq_detail']) : ?>
      <?php echo $value['qq_detail'];?>
      <?php endif ; ?>
      <?php if ($value['msn_detail']) : ?>
      <?php echo $value['msn_detail'];?>
      <?php endif ; ?>
      <?php if ($value['skype_detail']) : ?>
      <?php echo $value['skype_detail'];?>
      <?php endif ; ?>
      <?php if ($value['yahoo_detail']) : ?>
      <?php echo $value['yahoo_detail'];?>
      <?php endif ; ?>
      <?php if ($value['aliwangwang_detail']) : ?>
      <?php echo $value['aliwangwang_detail'];?>
      <?php endif ; ?>
    </p>
  </li>
</ul>
...
<div class="clear"></div>
<?php if($company['googleMapKey'] &&  $company['googleMapAddress']) { ?>
<div id="map_canvas" style="width:660px; height:350px; margin:20px 0; border:1px solid #cccccc;"></div>
<?php } ?>
</div>
      <div class="clear"></div>
    </div>
