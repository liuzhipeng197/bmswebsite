		...
		<div class="page">
        	...
        	<div class="newsdetail">
                ...
                <dl>
                    ...
                    <dd>
                    <?php if ($filename){ ?><?php if ($filename_type=='image'){ ?><br /><center><img src="<?php echo $filename;?>" alt='<?php echo $content['name'];?>' border="0" /></center><br /><?php }else{ ?><a href="<?php echo $filename;?>" target="_blank"><?php echo $lang['download'];?></a><br /><?php } ?><?php } ?>
