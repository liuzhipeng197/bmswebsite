    ...
    <div class="home_right">
      <div class="briefcontact">
        <div class="hotline">
          ...
          <span><?php echo trim($contact_tel_arr[0]);?></span></div>
        <ul>
          <li>
            <p><?php echo $lang['contact_person'];?>:</p>
            <span><?php echo $contact['contact_person'];?></span></li>
          <li class="tel">
            <p><?php echo $lang['fax'];?>:</p>
            <span><?php echo $contact['fax'];?></span></li>
          <?php foreach ($contact_email_arr as $key => $value)  { ?>
          <li>
            <p>
              <?php if ($key==0){ echo $lang['email'].":"; }?>
            </p>
            <span><a href="mailto:<?php echo trim($value);?>"><?php echo trim($value);?></a></span></li>
          <?php } ?>
        </ul>
      </div>
    </div>
    <div class="home_left">
      <div class="home_news">
        <?php  
				...
				?>
        <div class="title">
          <p><span><?php echo $info['name'];?></span><?php echo $lang['home_news'];?></p>
          <span><a href="<?php echo $info['url'];?>"><img src="<?php echo $conf['weburl'];?>/skin/<?php echo $skin;?>/<?php echo $directory;?>/images/more.gif" border="0" alt="" /></a></span></div>
        ...
        <div class="newsimage">
          ...
          <p><a href="<?php echo $value['url'];?>"><?php echo qt_news_title($value['return_name'],30);?></a><?php echo csubstr($value['abstract'],80);?></p>
          <?php } ?>
        </div>
        <?php } ?>
        <ul>
          <?php foreach ($news["newslist"] as $key => $value)  { ?>
          <li><a href="<?php echo $value['url'];?>" title="<?php echo $value['name'];?>"><?php echo qt_news_title($value['return_name'],34);?></a><span><?php echo $value['pubdate2'];?></span></li>
          <?php } ?>
        </ul>
      </div>
      ...
      <div class="home_products">
        <div class="title">
          <p><span><?php echo $lang['title_featured_products'];?></span><?php echo $lang['home_products'];?></p>
          <span><a href="<?php echo $menu['product_url'];?>"><img src="<?php echo $conf['weburl'];?>/skin/<?php echo $skin;?>/<?php echo $directory;?>/images/more.gif" border="0" alt="" /></a></span></div>
        <div class="home_ppics">
          <ul>
            ...
            <li>
              ...
              <span><a href="<?php echo $value['product_url'];?>" title="<?php echo $value['name'];?>" target="_blank"><?php echo $value['cutname'];?></a><br />
              <?php echo csubstr($value['description'],78); ?></span>
              <dl>
                <dd><a href="<?php echo $value['product_url']; ?>"  title="<?php echo $value['name']; ?>" target="_blank"><?php echo $lang['product_detail'];?></a></dd>
              </dl>
            </li>
            <?php } ?>
          </ul>
...
<div class="footer">
  <div class="footernav">
    ...
    <dl>
      ...
      <dd id="ft4"> <a href="javascript:void(0);" target="_self" onclick="javascript:AddFavorite('<?php echo $conf['weburl'];?>','<?php echo $company_desc['company_name'];?>')" rel="nofollow" ><?php echo $lang['add_favoriter'];?></a> </dd>
    </dl>
  </div>
  <div class="links">
...
['link_name'];?></a></li>
    ...
    <?php endif ; ?>
    <ul>
      <li><a href="links.html"><?php echo $lang['link_more'];?></a></li>
    </ul>
    <?php } ?>
  </div>
  <div class="copyright"> <span> Copyright &copy; <?php echo $conf['copyright_year'];?> <?php echo $company_desc['company_name'];?> <?php echo $lang['all_rights_reserved'];?>
    <?php if ( $conf['beian'] ) : ?>
    <a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow"><?php echo $conf['beian']; ?></a>
    <?php endif ; ?>
    <?php echo $conf['flow_code'];?> <?php echo $conf['online'];?></span>
    <p> <a href="http://www.nitc.cc" target="_blank"><img src="<?php echo $conf['weburl'];?>/skin/<?php echo $skin;?>/<?php echo $directory;?>/images/nitc.jpg" alt="http://www.nitc.cc" title="http://www.nitc.cc" border="0" /></a> </p>
  </div>
</div>
<div class="clear"></div>
