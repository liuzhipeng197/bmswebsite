...
<div class="wrapper">
  ...
  <div class="main">
    <div class="right">
      ...
      <div class="crumbs"> <a href="<?php echo $menu['index_url'];?>"><?php echo $lang['home'];?></a> &gt; <?php echo $company_desc['company_name'];?> </div>
      <div class="home_box">
        <?php if ($featured_product) : ?>
        <div class="home_products_featured">
          <div class="title">
            <p><?php echo $lang['title_featured_products'];?></p>
          </div>
          <div class="home_ppics">
            <ul>
              <?php foreach ($featured_product as $key => $value)  { ?>
              <li>
                <span><a href="<?php echo $value['product_url'];?>" target="_blank"><img src="<?php echo $value['image_url'];?>" alt="<?php echo $value['name'];?>" border="0" /></a></span>
                <h3><a href="<?php echo $value['product_url'];?>" title="<?php echo $value['name'];?>" target="_blank"><?php echo $value['cutname'];?></a></h3>
                <p><?php echo csubstr($value['description'],60); //默认截取60个字节输出，也可以自己定义该数字。如果设置为0为全部输出 ?></p>
              </li>
              <?php } ?>
            </ul>
          </div>
        ...
        <div class="home_products_new">
          <div class="title">
            <p><?php echo $lang['title_new_products'];?></p>
          </div>
          <div class="home_ppics">
            <ul>
        ...
        <div class="relative">
		  ...
		  <?php  
            ...
            <div class="title">
              ...
              <span><a href="<?php echo $info['url'];?>"><?php echo $lang['more'];?></a></span></div>
			...
			<?php }else{ ?>
			<div class="newsimage"><a href="<?php echo $info['url'];?>"><img src="<?php echo $conf['weburl'];?>/skin/<?php echo $skin;?>/<?php echo $directory;?>/images/newsimg.gif" alt="<?php echo $info['name'];?>" /></a>
			</div>
			<?php } ?>
			
            <ul>
              <?php foreach ($news["newslist"] as $key => $value)  { ?>
              <li><a href="<?php echo $value['url'];?>" title="<?php echo $value['name'];?>"><?php echo qt_news_title($value['return_name'],43);?></a></li>
              <?php } ?>
            </ul>
          </div>
          <div class="home_about">
            <div class="title">
              <p><?php echo $lang['title_aboutus'];?></p>
              <span><a href="<?php echo $menu['aboutus_url'];?>"><?php echo $lang['more'];?></a></span></div>
            <div class="about"><?php echo csubstr($aboutus, 270); //默认截取270个字节输出，也可以自己定义该数字。如果设置为0为全部输出 ?></div>
          </div>
          <div class="clear"></div>
        </div>
      </div>
...
['link_name'];?></a></li>		
    ...
    <div class="copyright"> <span> Copyright &copy; <?php echo $conf['copyright_year'];?> <?php echo $company_desc['company_name'];?> <?php echo $lang['all_rights_reserved'];?>
      ...
      <p> <a href="http://www.nitc.cc" target="_blank"><img src="<?php echo $conf['weburl'];?>/skin/<?php echo $skin;?>/<?php echo $directory;?>/images/nitc.jpg" alt="http://www.nitc.cc" border="0" /></a> </p>
  </div>
  <div class="clear"></div>
