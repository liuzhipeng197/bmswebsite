...
<div class="main">
	<div class="right">
        ...
        <div class="page">
            <div class="maintitle">
                <p><?php echo $product_detail['name'];?></p><span></span>
            </div>
				...
				<span><span id="e">
					<span class="msgbase">
						<input name="confirmText" type="text" id="confirmText" onblur="confirmTextCheck('confirmText')" size="10" />
						  <img src="<?php echo $conf['weburl'];?>/captcha.php" alt="captcha" style="vertical-align:top;cursor:pointer;" onclick="this.src='<?php echo $conf['weburl'];?>/captcha.php?'+Math.random()" />
					</span>
