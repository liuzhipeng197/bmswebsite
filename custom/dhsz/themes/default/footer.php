...
<div class="footer">
    ...
    <div class="copyright">
        ...
        <p>
		<a href="http://www.nitc.cc" target="_blank"><img src="<?php echo $conf['weburl'];?>/skin/<?php echo $skin;?>/<?php echo $directory;?>/images/nitc.jpg" alt="http://www.nitc.cc" border="0" /></a>
		</p>
</div>
<div class="clear"></div>
