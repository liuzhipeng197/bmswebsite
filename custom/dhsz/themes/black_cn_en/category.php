		...
		<div class="page">
			...
			<?php if(!$category_desc_no_show) {?>
                ...
                <?php } if ($sub_category) : ?>
					...
					<li>
					<p>
					<a href="<?php echo $value['category_url'];?>" title="<?php echo $value['name'];?>"><img src="<?php echo $value['sub_category_image_url'];?>" width="110" height="110" alt="<?php echo $value['name'];?>" border="0" /></a></p><span><a href="<?php echo $value['category_url'];?>" title="<?php echo $value['name'];?>"><?php echo $value['name'];?></a></span>
					</li>
					<?php } ?>		
					</ul>
					</div>
