	...
	<div class="right">
		...
		<div class="home_box">
			...
			<div class="home_news">
				...
				<div class="title"><p><?php echo $info['name'];?></p><span><a href="<?php echo $info['url'];?>"><?php echo $lang['more'];?></a></span></div>
					...
					<div class="newsimage">
							...
							<p><a href="<?php echo $value['url'];?>"><?php echo qt_news_title($value['return_name'],34);?></a><?php echo csubstr($value['abstract'],80);?></p>
							<?php } ?>
					</div>
					<?php } ?>
					<ul>
			...
			<div class="home_about">
				...
				<div class="about"><?php echo csubstr($aboutus,400);?></div>
			</div>
			<div class="clear"></div>
			</div>
...
['link_logo'];?></a></li>		
			...
			<?php if ($link_text) : ?>
				...
				<a href="<?php echo $value['link_url'];?>" target="_blank"><?php echo $value
['link_name'];?></a>		
				<?php } ?>

			<?php endif ; ?>
			<a href="links.html"><?php echo $lang['link_more'];?></a>
		<?php } ?>
	</div>
